...
if (Fpush > mu_s * (Gboard + mbase * g)):
	...
	densities = [("Water", 997), ("Sand", 1602)] # Densities (kg/m^3)
	...
	for material in densities:
		...
		print(f"The dimensions for a {material[0]} base are:\nWidth: {round(wb, 3)}m, Length: {round(base_length, 3)}m, Height: {round(hb, 3)}m.")
		print(f"Volume Needed: {round(volume_needed,3)}m^3\n")
